  ...
  const columns = [
      ...
      },
      {
        ...
        Cell: ({ renderedCellValue, row }) => (
          ...
          >
            ...
            <a href={row.original.link}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mt-0.5">
      ...
      },
      {
        ...
        Cell: ({ renderedCellValue, row }) => (
          ...
          >
            <span>{new Date(renderedCellValue).toLocaleDateString("en-US", { month: "long", day: "numeric" })}</span>
          </Box>
        ),
      },
    ]
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between p-6 pb-0">
          <div className="border-b border-gray-200 dark:border-gray-700">
            <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
              <li className="mr-2">
                <a href="/" className="inline-flex p-4 text-indigo-600 border-b-2 border-indigo-600 active group font-bold" aria-current="page">
                  <svg aria-hidden="true" className="w-5 h-5 mr-2 text-indigo-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                  </svg>Unpaid
                </a>
              </li>
              <li className="mr-2">
